...
function render(t,ps){
  ...
  root.innerHTML='<div class="page-head"><div><h1>🏆 King King Torneo Individuale a Coppie Variabili</h1><p>'+esc(t.nome)+' · gestione autonoma · classifica individuale</p></div><button class="btn" id="rotBack">← Torna ai tornei</button></div>'+
