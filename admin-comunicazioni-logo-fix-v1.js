...
function buildWhatsAppMessage(t){const link=buildBoveLink(t);const note="Presentarsi 15 minuti prima dell'orario della propria partita.";const brand=window.NP_SYSTEM_CONFIG?.nomeAttivita||"Organizzazione sportiva";return `🎾 TORNEO ${t.nome||''}\n\n${brand}\n\nCiao!\n\nIl tabellone del torneo è disponibile.\n\n👉 ${link}\n\n📌 NOTA DI INGRESSO\n${note}\n\nBuon torneo! 🎾`;}
